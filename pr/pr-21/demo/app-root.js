...
`,Ae=l`var(--white, #fff)`,ot=l`var(--primaryDisableCTAFill, #767676)`,st=l`var(--secondaryCTABorder, #999)`,rt=l`var(--primaryCTAFill, #194880)`,ee=l`var(--primaryCTAFillRGB, 25, 72, 128)`,nt=l`var(--primaryCTABorder, #c5d1df)`,at=l`var(--primaryErrorCTAFill, #d9534f)`,te=l`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,lt=l`var(--primaryErrorCTABorder, #d43f3a)`,dt=l`var(--secondaryCTAFill, #333)`,ie=l`var(--secondaryCTAFillRGB, 51, 51, 51)`,ct=l`var(--primaryCTABorder, #979797)`,ht=l`#ee8950`,pt=l`#ec7939`,Re=l`
  .ia-button {
    height: 3.5rem;
    min-height: 3rem;
    cursor: pointer;
...
`,ut=Object.freeze({processing:"processing",complete:"complete"});class Ue extends A{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=ut.processing}render(){return v`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}}window.customElements.define("ia-activity-indicator",Ue);const Ee=l`var(--white, #fff)`,vt=l`var(--primaryDisableCTAFill, #767676)`,ft=l`var(--secondaryCTABorder, #999)`,mt=l`var(--primaryCTAFill, #194880)`,oe=l`var(--primaryCTAFillRGB, 25, 72, 128)`,gt=l`var(--primaryCTABorder, #c5d1df)`,yt=l`var(--primaryErrorCTAFill, #d9534f)`,se=l`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,bt=l`var(--primaryErrorCTABorder, #d43f3a)`,wt=l`var(--secondaryCTAFill, #333)`,re=l`var(--secondaryCTAFillRGB, 51, 51, 51)`,$t=l`var(--primaryCTABorder, #979797)`,kt=l`#ee8950`,_t=l`#ec7939`,xt=l`
  .ia-button {
    height: 3.5rem;
    min-height: 3rem;
    cursor: pointer;
